...
export default {
  ...
  home: {
    ...
    nb2FeaturesHeading: 'Key features',
  ...
  editor: {
    ...
    resolutionOption1: '1K (1024×1024) · Credit saver',
    resolutionOption2: '2K (2048×2048) · Standard',
    resolutionOption3: '4K (4096×4096) · Ultra detail',
    resolutionNote1: '1K saves credits and is great for drafts or rapid iterations.',
    resolutionNote2: '2K is the balanced default option.',
    resolutionNote3: '4K uses roughly double credits for premium detail.',
    ...
    newApiProviderAuthFailed: 'New API provider authentication failed',
    newApiProviderNoPermission: 'New API provider has no permission to access this resource',
    newApiProviderQuotaExhausted: 'New API provider quota exhausted, please try again later',
    newApiProviderServerError: 'New API provider server error, please try again later',
    newApiProviderError: 'New API provider error',
    newApiProviderTimeout: 'New API provider request timeout, please check network connection and try again',
    newApiProviderFailed: 'New API provider call failed',
    newApiProviderInvalidResponse: 'API response format is incorrect',
    newApiProviderNoImageData: 'No image data found in API response',
    newApiProviderInvalidImageFormat: 'Invalid image data format returned by API',
    ...
    generatingWithModel: 'Generating image using {model}...',
    editingWithModel: 'Editing image using {model}...',
    pleaseWait: 'Please wait, this may take a few seconds',
    downloadImage: 'Download Image',
    costDisplayTitle: 'Credit consumption',
  ...
  showcase: {
    forumTitle: 'Forum',
    forumSubtitle: 'Share prompts, images, and inspiration with the Nano Banana community.',
    navLatest: 'Latest',
    navTrending: 'Trending',
    searchPlaceholder: 'Search prompts, tags or creators…',
    submitButton: 'Submit',
    emptyStateTitle: 'No posts yet',
    emptyStateDescription: 'Be the first to share your Nano Banana creation.',
    loginReminder: 'Please log in to continue.',
    ...
    modalTitlePlaceholder: 'Give your post a title',
    modalPromptLabel: 'Prompt',
    modalPromptPlaceholder: 'Describe the prompt you used',
    modalTagsLabel: 'Tags',
    ...
    commentLoginCta: 'Log in to join the discussion.',
    commentEmpty: 'No comments yet',
    formMissingFields: 'Please provide both an image and prompt.',
    formImageRequired: 'Image is required',
    genericError: 'Something went wrong. Please try again.',
    defaultPostTitle: 'Untitled post by {name}',
    title: 'Showcase',
  ...
  login: {
    ...
    termsText: 'By logging in or registering, you agree to our',
    ...
    verificationMessage: 'A confirmation email has been sent. Click the link in the email to finish your registration.',
    socialLoginFailed: 'Social login failed, please try again later'
  },
  resetPassword: {
